...
export const coursesList = [
    { id: 1, courseName: 'Факультет разработки на ', titleKey: 'Java' },
    { id: 2, courseName: 'Факультет разработки на ', titleKey: 'PYTHON' },
    { id: 3, courseName: 'Факультет ', titleKey: 'Frontend' },
    { id: 4, courseName: 'Факультет', titleKey: 'testing' },
];

export const accordeonTitle = {
